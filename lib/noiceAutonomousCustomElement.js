...
/*
    ...
    entries here will generate a css variable declaration thusly:
        ...
        this.getStyleVar('main-background-color'), will return:
...
constructor(args){
    ...
    // same for styleVars
    this.styleVars = JSON.parse(JSON.stringify(this.getStyleDefaults()));
...
initConstructorArgs(args){
    ...
    if (args instanceof Object){
        ...
        this.styleVars = Object.assign({}, (args.styleVars instanceof Object)?args.styleVars:{});
...
/*
    6/24/24 @ 2330 -- gotta go to bed
    working on styleVars.
    next up is to implement setStyleVar()
