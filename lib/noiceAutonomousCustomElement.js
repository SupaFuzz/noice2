...
spawnAttributeAccessors(){
    Object.keys(this.attributeDefaults).forEach((a) => {
        Object.defineProperty(this, a, {
            ...
            get: () => { return((this.initialized && this.hasAttribute(a))?this.getAttribute(a):this.attributeDefaults[a].value); },
            set: (v) => { if (this.initialized && this.hasAttribute(a)){ this.setAttribute(a, v); }else{
                let old = this[a];
                this.attributeDefaults[a].value = v;
                if (this.initialized && (this.attributeChangeHandlers instanceof Object) && (this.attributeChangeHandlers[a] instanceof Function)){
                    this.attributeChangeHandlers[a](a, old, v, this);
                }
            }}
        })
    }, this);
