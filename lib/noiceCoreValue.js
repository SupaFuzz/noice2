...
set changeFlag(v){
    if (this.changeFlagCallback instanceof Function){ this.changeFlagCallback(this.changeFlag, (v === true), this); }
...
validateNullable(){
    ...
    return((! this.nullable) && this.isNull(value));
}
...
removeValidationError(messageNumber){
    if (! isNaN(parseInt(messageNumber))){
        this.errors = this.errors.filter((a) => {
            (a instanceof Object) &&
