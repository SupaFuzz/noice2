...
getTimeInterval(seconds, asStringBool){
    ...
    if (asStringBool === true){
        if (out.days > 0){
            return(`${out.days}:${String(out.hours).padStart(2,0)}:${String(out.minutes).padStart(2,0)}:${String(out.seconds).padStart(2,0)}`)
        }else{
            return(`${String(out.hours).padStart(2,0)}:${String(out.minutes).padStart(2,0)}:${String(out.seconds).padStart(2,0)}`)
        }
    }else{
        return(out);
    }
