...
getGUID(altCache){
    let guid;
    let guidCache = (altCache instanceof Array)?altCache:(this._usedGUIDs instanceof Array)?this._usedGUIDs:[];
    do {
    ...
    guidCache.push(guid);
    if ((this._usedGUIDs instanceof Array) && (this._usedGUIDs.length > this.usedGUIDMaxCache)){ this._usedGUIDs.shift(); }
    return(guid);
}
...
export { isNull, isNotNull, epochTimestamp, toEpoch, fromEpoch, getGUID };
