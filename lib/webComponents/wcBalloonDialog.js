    ...
    if ((el instanceof Element) && (this.parentElement instanceof Element)){
        ...
        switch ((alignmentMode == 'auto')?this.arrow_position:alignmentMode){
            case 'topRight':
                ...
                // remove me
                console.log(`self: `, myD);
                console.log(`relativeElement: `, targetD);
                console.log(`parent: `, parent);

                if (targetD.width <= myD.width){
                    console.log(`(((${targetD.x} - ${parent.x}) + ${targetD.width}) - ${myD.width} + parseFloat(${this.arrow_offset}) + parseFloat(${this.arrow_size})) - (${targetD.width}/2) `)
                    ...
                    console.log(`set: ${this.x}`);
                }else{
                    console.log(`((${targetD.x} - ${parent.x}) + ${targetD.width}) - ${myD.width}`);
