/*
    wcFactory.js
    5/20/24 Amy Hicox <amy@hicox.com>

    sketch of an idea that creates a basic div-wrapped web component
    from input. Or something like that. Working on it


    hold up. should this be a wc sublass?
    or should this be it's own thing that builds wcs and returns them?

    good night. think on it tomorrow.
*/
import { noiceAutonomousCustomElement } from '../noiceAutonomousCustomElement.js';

class wcFactory extends noiceAutonomousCustomElement {




static classID = wcFactory;
...
*/
getAttributeDefaults(){
    return(wcFactory.classAttributeDefaults);
}
