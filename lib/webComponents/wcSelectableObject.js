...
static classAttributeDefaults = {
    ...
    selected_background: { observed: true, accessor: true, type: 'str', value: 'none', forceAttribute: true, forceInit: true },
    selected_background_color: { observed: true, accessor: true, type: 'str', value: 'rgba(240, 240, 240, .5)', forceAttribute: true, forceInit: true },
}
...
constructor(args){
    ...
    this.attributeChangeHandlers = {
        ...
        selected_background: (n, o, v, s) => {
            s.setStyleVar('selected-background', s.isNotNull(v)?v:'none', {global: false})
        },
        selected_background_color: (n, o, v, s) => {
            s.setStyleVar('selected-background-color', s.isNotNull(v)?v:'rgba(240, 240, 240, .5)', {global: false})
        }
    };
