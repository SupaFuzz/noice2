...
wcPieChart.registerElement('wc-tbl-wc-pie-chart');
wcBasic.registerElement('wc-tbl-wc-basic');
wcFormElement.registerElement('wc-tbl-wc-form-element');
