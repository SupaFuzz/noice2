...
static classAttributeDefaults = {
    ...
    burger_menu_title: { observed: true, accessor: true, type: 'str', value: 'burgers', forceAttribute: true, forceInit: true },
...
openStatusMenu(bool){
    if (this.initialized && (this.statusMenu instanceof wcBalloonDialog)){
        if (bool === true){ this.shadowDOM.appendChild(this.statusMenu); }else{ this.statusMenu.exit(); }
    }
}
...
userQuery(args){
    ...
    return(new Promise((toot, boot) => {
        ...
        that.dispatchEvent(new CustomEvent("open_dialog", { detail: {self: that, dialog_name: 'user_query' }}));
