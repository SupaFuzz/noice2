...
static classAttributeDefaults = {
    ...
    narrow: { observed: true, accessor: true, type: 'bool', value: false }
...
static classStyleDefaults = {
    ...
    'header-background-color': { value: 'rgba(70, 7, 141)', global: true },
    'header-box-shadow': { value: '0px 2px 3px rgba(20, 22, 23, .25)', global: true},
    'control-font': { value: "Comfortaa", global: true },
    'header-border-bottom': { value: '.128em solid rgb(155, 136, 177)', global: true },
    ...
    'legend-color': { value: 'rgba(70, 7, 141, .6)', global: true },
...
modifyFieldValue(fieldName, value, captureValueBool){
    if (this.initialized && (this.formElements[fieldName] instanceof wcFormElement)){
        ...
        if (this.show_modified_field_indicator === true){
            ...
            let that = this;
            setTimeout(() => { that.formElements[fieldName].dataset.updated = false}, (1.5 * 1000));
        }
    }
}
