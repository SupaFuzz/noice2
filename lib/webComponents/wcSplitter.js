...
get defaultStyle(){return(`
    ...
    .wcSplitter {
        ...
        background-color: var(--wc-splitter-background-color, rgba(0, 0, 255, .25));
        user-select: none;
    }
    .section {
        overflow-x: auto;
    ...
    .section[data-_name="a"]{
        background-color: var(--wc-splitter-a-background-color, rgb(12, 0, 117));
    ...
    .section[data-_name="b"]{
        background-color: var(--wc-splitter-b-background-color, rgb(12, 0, 117));
