/*
    ...
    to resize the split.
        ...
        TO-DO 6/5/24 @ 1025
        * orientation change after drag has issues
...
constructor(args){
    ...
    this.attributeChangeHandlers = {
        orientation: (attributeName, oldValue, newValue, selfReference) => {
            ...
            // 6/5/24 @ 2225 -- this should work but does not
            //selfReference.resetSplit();
            selfReference.homeHandle();
        }
        /*
            ex
...
get defaultStyle(){return(`
    ...
    :host([orientation="vertical"]) .handle:firstChild .defaultHandle{
        margin-left: unset;
    }
`)};
