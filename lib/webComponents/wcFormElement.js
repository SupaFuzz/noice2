...
get defaultStyle(){return(`
    ...
    :host([disabled="true"]) .formElement, :host([disabled="true"]) .btnContainer button, .btnContainer button:disabled {
      background-color: var(--wc-formelement-disabled-field-background-color);
      color: var(--wc-formelement-disabled-field-text-color);
    }
    ...
    @keyframes modifyIndicator {
        ...
        100%  { background-color: var(--wc-formelement-field-modified-end-color, rgba(242, 177, 52, 0)); }
    }
