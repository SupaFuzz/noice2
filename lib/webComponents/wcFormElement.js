...
initializedCallback(){
    ...
    [
        ...
        'cols', 'rows', 'wrap', 'spellcheck', 'inputmode', 'maxlength'
    ].forEach((a) => {
        this[a] = this[a];
    }, this);
}
...
get defaultStyle(){return(`
    ...
    :host([disabled="true"]) label, :host([disabled="true"]) .message {
      color: var(--wc-formelement-disabled-label-color, rgb(240, 240, 240));
    }
    :host([disabled="true"]) .formElement, :host([disabled="true"]) .btnContainer button, .btnContainer button:disabled {
      background-color: var(--wc-formelement-disabled-field-background-color, var(--wc-formelement-field-background-color, transparent));
      color: var(--wc-formelement-disabled-field-text-color, var(--wc-formelement-field-foreground));
      border: var(--wc-formelement-disabled-field-border, var(--wc-formelement-field-border));
      box-shadow: var(--wc-formelement-disabled-field-box-shadow, var(--wc-formelement-field-boxshadow));
    }

    /* required */
    :host([required="true"]:not([disabled="true"])) label {
      color: var(--wc-formelement-required-label-color, rgb(240, 240, 240));
    }

    /* buttons */
    .btnContainer button{
      background-color: var(--wc-formelement-button-background-color);
      color: var(--wc-formelement-button-foreground-color);
    }

    label {
      color: var(--wc-formelement-label-color);
      font-family: var(--wc-formelement-label-font, inherit);
    }
    ...
    .formElement {
      background: var(--wc-formelement-field-background);
      background-color: var(--wc-formelement-field-background-color, transparent);
      border: var(--wc-formelement-field-border);
      color: var(--wc-formelement-field-foreground);
      box-shadow: var(--wc-formelement-field-boxshadow);
      font-family: var(--wc-formelement-field-font, inherit)
    }
    .formElement:focus {
      color: var(--wc-formelement-field-focus-foreground, var(--wc-formelement-field-foreground));
      background: var(--wc-formelement-field-focus-background);
      background-color: var(--wc-formelement-field-focus-background-color, transparent);
      box-shadow: var(--wc-formelement-field-focus-box-shadow, none);
    }
    :host([message_is_error="true"]) .formElement {
      border-color: var(--wc-formelement-field-error-border-color);
    }
    .formElement optgroup {
      background-color: var(--wc-formelement-optgroup-background-color);
      color: var(--wc-formelement-optgroup-foreground-color);
    }
    .formElement option {
      background-color: var(--wc-formelement-option-background-color);
      color: var(--wc-formelement-option-foreground-color);
    }
    ...
    @keyframes modifyIndicator {
        0%    { background-color: var(--wc-formelement-field-modified-start-color, rgba(242, 177, 52, .5)); }
        100%  { background-color: var(--wc-formelement-field-modified-end-color, var(--wc-formelement-field-background-color, transparent)); }
    }

    /* message */
    .message {
      color: var(--wc-formelement-message-color);
    }
    :host([message_is_error="true"]) .message {
      color: var(--wc-formelement-error-message-color);
    }
    ...
    :host([message_is_error="true"]) .formElement {
        font-style: var(--wc-formelement-error-message-font-style, italic);
        color: var(--wc-formelement-error-message-color);
    }
    ...
    /* the null option */
    option.nullOption {
        font-style: var(--wc-formelement-default-option-font-style, italic);
        color: var(--wc-formelement-default-option-color, inherit);
    }
`)}
...
get value(){
    return(
        this.valueFormatter((this.initialized && this.isNotNull(this.formElement))?this.formElement.value:this.default_value)
    )
}
set value(v){
    if (this.initialized && this.isNotNull(this.formElement)){ this.formElement.value = this.isNull(v)?'':v; }
}
        ...
        if (this.type == "select"){
            ...
            if (data instanceof Array){
                ...
                data.map((value) => {
                    ...
                    return(el);
                }, this).forEach((el) => { this.formElement.add(el); }, this);
...
handleIncludeNull(bool){
    if (this.type == "select"){
        ...
        }else if (this.nullOption instanceof Element){
