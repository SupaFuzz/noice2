...
/*
    ...
    REFACTOR: as custom event dispatch -> 'captureValue'
    https://developer.mozilla.org/en-US/docs/Web/Events/Creating_and_triggering_events
    LOH -- 4/22/24 @ 2149 -- is time for bed, this is for tomorroew
*/
captureValue(evt){
...
/*
    ...
    REFACTOR: as custom event dispatch -> 'undoClick'
    note also that this can no longer be asynchronous
    so it's on the handler to enable/disable the button
...
/*
    ...
    REFACTOR: as custom event dispatch -> 'menuClick'
    note also that this can no longer be asynchronous
    so it's on the handler to enable/disable the button
*/
menuClickhandler(evt){
