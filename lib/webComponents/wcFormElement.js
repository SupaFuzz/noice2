...
static classAttributeDefaults = {
    ...
    */
    ...
    /*
        ...
        also this because we cannot catch dataset properties on body down in a shadowDOM
        theme:                      <light|dark> ... maybe more later I dunno -- remembering to update everthing is gonna suck
    */
    theme: { observed: true, accessor: true, type: 'str', value: 'dark', forceAttribute: true },
...
/*
    setTheme(themeName)
    this simply changes the value of .dataset.theme on this.DOMElement
    the rest is up to you in the CSS
    well shit. we don't need this either because we can just detect the theme attribute in the css

setTheme(themeName){
        let el = this.DOMElement;
        if (el instanceof Element){ el.dataset.theme = themeName; }
