...
static classAttributeDefaults = {
    ...
    /*
        LOH 5/22/24 @ 2233
        content works.
        css is next also not a deferred attribute
    */

    /* deferred attributes
    content: { observed: false, accessor: false, type: 'HTMLContent', value: null, deferred: true },
    css: { observed: false, accessor: false, type: 'CSSContent', value: null, deferred: true }
    */
...
getHTMLContent(){
    ...
    if ((this._content instanceof Element) || this.isNotNull(this._content)){
        ...
        // the standard noice style container div
        let div = document.createElement('div');
        div.className = this._className;

        /*
            insert default shenanigans here
        */
