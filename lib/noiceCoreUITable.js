/*
    ...
    * handleCellEdit(rowElement, cellElement)
    ...
    whatever ya want:
        ...
        .noiceCoreUITable .tablePrefEditor, .noiceCoreUITable .userPrompt  {
        ...
        .noiceCoreUITable .userPrompt h2.prompt {
           margin: 0;
           font-family: Comfortaa;
        }
        .noiceCoreUITable .userPrompt div.buttonContainer {
           text-align: center;
        }
        .noiceCoreUITable .userPrompt div.buttonContainer button {
           font-family: Comfortaa;
           font-size: .8em;
        ...
        .noiceCoreUITable .footer .buttonContainer .btnSelectAll, .noiceCoreUITable .footer .buttonContainer .btnSelectNone {
        ...
        .noiceCoreUITable .footer .buttonContainer .btnSelectAll:active, .noiceCoreUITable .footer .buttonContainer .btnSelectNone:active {
           background-color: rgb(240, 240, 240);
           color: rgb(22, 23, 25);
        }
        .noiceCoreUITable .footer .buttonContainer .btnSelectAll:disabled, .noiceCoreUITable .footer .buttonContainer .btnSelectNone:disabled {
           opacity: .2;
        }
*/
...
get html(){
    return(`
        ...
        <div data-templatename="uiContainer" data-templateattribute="true" style="position: relative;">
        ...
        ">
            <div class="buttonContainer" data-templatename="footerButtonContainer" style="text-align: left;">
                <button class="btnPrefs" data-templatename="btnPrefs" data-templateattribute="true">⚇</button>
                <button class="btnSelectAll" data-templatename="btnSelectAll" data-templateattribute="true">select all</button>
                <button class="btnSelectNone" data-templatename="btnSelectNone" data-templateattribute="true">select none</button>
                <button class="btnExport" data-templatename="btnExport" data-templateattribute="true">export</button>
            </div>
...
setup(){
    ...
    let that = this;
    that._DOMElements.btnPrefs.addEventListener('click', (evt) => { that.openPrefEditor(evt); });
    that._DOMElements.btnSelectAll.addEventListener('click', (evt) => { that.handleSelectAll(evt); });

    // pre-spawn the table preferences editor frame thingy
    that.prefEditorFrameThingy = new noiceCoreUIOverlay({
        getHTMLCallback: () => { return(`<div class="uiContainer" data-templatename="uiContainer" data-templateattribute="true"><div>`); },
        fullscreen: true,
        zIndex: 2,
    ...
    return(new Promise((toot, boot) => {
        if (
            ...
            that.editCellCallback(rowElement, cellElement, that).then((value) => {
                ...
                new Promise((_t,_b) => {
                    if ((that.selectMode == 'multiple') && (that.numSelectedRows > 1)){
...
handleSelectAll(evt){
    ...
    new Promise((toot, boot) => {
        ...
        that._DOMElements.btnSelectAll.disabled = false;
    })
}
