...
get html(){
    return(`
        ...
        <div data-templatename="uiContainer" data-templateattribute="true" style="position: relative; height: 100%; width: 100%;">
...
setup(){
    ...
    that.prefEditorFrameThingy = new noiceCoreUIOverlay({
        getHTMLCallback: () => { return(`<div class="uiContainer" data-templatename="uiContainer" data-templateattribute="true" style="width:100%; height:100%;display:grid;align-content:center;"><div>`); },
        fullscreen: true,
        zIndex: 2,
