...
setup(){
    ...
    that._DOMElements.btnSelectNone.addEventListener('click', (evt) => { that.handleSelectNone(evt); });
    that._DOMElements.btnExport.addEventListener('click', (evt) => { that.openExportUI(evt); });
    that._DOMElements.btnNudgeUp.addEventListener('click', (evt) => { that.nudgeSelection('up', 1); });
    that._DOMElements.btnNudgeDown.addEventListener('click', (evt) => { that.nudgeSelection('down', 1); });
...
getFooterMessage(){
    ...
    that._DOMElements.btnSelectNone.disabled = (this.numSelectedRows < 1);
    that._DOMElements.btnSelectAll.disabled = (this.numRows == this.numSelectedRows);
    that._DOMElements.btnExport.disabled = (this.numRows == 0);
