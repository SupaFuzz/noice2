                        ...
                        */
                        ...
                        api.getFormFields({ schema: formName }).then((formDef) => {
                            ...
                            if (
                                ...
                                formDef = that.config.DBs[that.formDBMappings[formName].dbTagName].storeDefinitions[that.formDBMappings[formName].storeName]._sync.formDefinitionTransform(formDef);
                            }
